...
# The purpose of program is to give the population change when the user enters 5 values.
...
print("The population change is", int(pop_change), 'people')

# Code should calculate future population and print it.
future_pop = (population + pop_change)
print("The future population is", int(future_pop), 'people')
